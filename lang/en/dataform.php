...
$string['modulename_help'] = 'The dataform module may be used for creating a wide range of activities/resources
by allowing the instructor/manager to design and create a custom content form from various input elements (e.g.  texts, numbers, images, files, urls, etc.),
and participants to submit content and view submitted content.';
...
$string['inlineview_help'] = 'You can select one of this Dataform\'s views to displayed on the course page
instead of the activity link. If this is a new instance you need save it and create at least one view before selecting an inline view.';
...
$string['timeavailable_help'] = 'The designated start time of the activity. This time appears in the course calendar.
The \'earlyentry\' set of capabilities allows for controling entry permissions before this time.';
$string['timedue'] = 'Due';
$string['timedue_help'] = 'The designated end time of the activity. This time appears in the course calendar.
The \'lateentry\' set of capabilities allows for controling entry permissions after this time.';
...
$string['intervalcount_help'] = 'If the activity is set to have more than 1 interval then the availability settings
and the entry settings apply to each interval separately.';
...
$string['entriesrequired_help'] = 'The number of entries a user without manageentries capability is required to add for the activity to be considered complete
(before consideration of other completion criteria such as grade). If the activity has intervals this number applies to each interval,
and the number of required entries for the whole activity is this number times the number of intervals.';
...
$string['fieldtemplate_help'] = 'The field template allows for specifying a designated field label that can be added to the view by means of the [[fieldname@]] field pattern.
This field pattern observes the field visibility and is hidden if the field is set to be hidden.
The field template can also serve as a field display template and it interprets patterns of that field if included in the label.
For example, with a number field called Number and the field label defined as \'You have earned [[Number]] credits.\'
...
$string['configanonymousentries'] = 'This switch will enable the possibility of guest/anonymous entries for all dataforms.
You will still need to turn anonymous on manually in the settings for each dataform.';
$string['configenablerssfeeds'] = 'This switch will enable the possibility of RSS feeds for all dataforms.
You will still need to add rss views in the Dataform instance to generate a feed.';
...
$string['viewdescription_help'] = 'Short description of the view purpose and characteristics to allow managers to see at a glance what each view is intended for.
This description is displayed only in the view management list.';
...
$string['entrytemplate_help'] = 'The entry template allows you to determine content, behaviour and general layout of an entry both for browsing and for editing.
This template typically contains field elements for displaying and updating the entry content.
When creating a new view, the template is populated automatically with a default layout that consists of base field patterns, edit action and delete action.
You can then add or remove patterns as needed. The WYSIWYG editor also allows you to decorate the template and create your own look and feel with color, font and images.';
$string['viewname'] = 'View name';
$string['viewname_help'] = 'Short name for the view. The view name can be used in certain view patterns in which case the format of the name should as simple as possible,
only alpha or alphanumeric characters, to avoid pattern parsing problems.';
...
$string['viewperpage_help'] = 'The max number of entries to display in the view at any given time.
If the number of viewable entries is higher than the selected per-page a paging bar will be displayed (provided the ##paging:bar## is added to the view template).';
...
$string['viewtemplate_help'] = 'The view template allows you to determine content, behaviour and general layout of a front view page in the Dataform activity.
This template typically contains elements for activity navigation, search and sort, and entries display.
When creating a new view, the template is populated automatically with a default layout and you can then add or remove elements as needed.
The WYSIWYG editor also allows you to decorate the template and create your own look and feel with color, font and images.';
$string['viewtiming'] = 'View timing';
$string['viewtiming_help'] = 'Set From and/or To dates to restrict access to the view only between the specified dates to any one without accessanytime capability.
Tick the \'Set as default\' checkbox to set the view as the default view when it becomes available.';
...
$string['viewvisibility_help'] = 'Set to No if you wish to condition access to the view (require viewaccesshidden capability). By default managers can access hidden views.
Users who cannot access a view will not see the view link in the views menu and navigation.';
...
$string['submissionredirect_help'] = 'By default the user remains in the same view after entry submission.
If an alternate view is selected, the user will be redirect to that view after submission.';
