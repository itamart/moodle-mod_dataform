...
/**
 * The mod_dataform view updated event.
 *
...
class view_updated extends view_base {
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'dataform', 'views update', 'view/index.php?d=' . $this->other['dataid'] . '&amp;vedit=' .
