...
/**
 * The mod_dataform field created event.
 *
...
class field_created extends field_base {
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'dataform', 'fields add', 'field/index.php?d=' . $this->other['dataid'] . '&amp;fid=' .
