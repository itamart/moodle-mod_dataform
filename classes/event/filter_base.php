...
/**
 * The mod_dataform filter base event.
 *
...
abstract class filter_base extends \core\event\base {
    ...
    protected function validate_data() {
        ...
        if (!isset($this->other['filtername'])) {
            throw new \coding_exception('The filtername must be set in $other.');
        }
