...
/**
 * The mod_dataform view deleted event.
 *
...
class view_deleted extends view_base {
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'dataform', 'views delete', 'view/index.php?d=' . $this->other['dataid'] . '&amp;delete=' .
