...
/**
 * The mod_dataform filter updated event.
 *
...
class filter_updated extends filter_base {
    ...
    public function get_legacy_logdata() {
        return array($this->courseid, 'dataform', 'filters update', 'filter/index.php?d=' . $this->other['dataid'] . '&amp;fid=' .
