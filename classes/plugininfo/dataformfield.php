...
class dataformfield extends base {
     ...
     * Calls {@link \mod_dataform\plugininfo\dataformfield::is_instantiable()}.
    ...
    public static function get_instantiable_plugins($context) {
        ...
        if (!$plugins = \core_plugin_manager::instance()->get_plugins_of_type('dataformfield')) {
            return null;
        }
    ...
    public function is_instantiable($context) {
        $capability = 'dataformfield/' . $this->name . ':addinstance';
