...
/**
 * PHPUnit dataformfield_ratingmdl rating testcase
 *
 * @package    dataformfield_ratingmdl
 * @category   phpunit
 * @group      mod_dataform
 * @group      dataformfield_ratingmdl
 * @copyright  2014 Itamar Tzadok {@link http://substantialmethods.com}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class dataformfield_ratingmdl_rating_testcase extends advanced_testcase {
    ...
    function test_get_ratings_sql() {
        ...
        // We load 3 entries. Each is rated twice. For simplicity itemid == user id of the entry owner
