...
class mod_dataform_field_url_form extends mod_dataform_field_form {
    ...
    //-------------------------------------------------------------------------------
        ...
        // use url picker
        $mform->addElement('selectyesno', 'param4', get_string('usepicker', 'dataformfield_url'));
        ...
        // apply media filter
        $mform->addElement('selectyesno', 'param3', get_string('allowmediafilter', 'dataformfield_url'));
    }
