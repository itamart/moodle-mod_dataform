...
class mod_dataform_field__rating_patterns extends mod_dataform_field_patterns {
    ...
    public function get_replacements($tags = null, $entry = null, array $options = null) {
        ...
        if ($entry->id > 0) {
            ...
            $aggravg = round($entry->rating->aggregate[dataform_field__rating::AGGREGATE_AVG], 2);
            $aggrmax = round($entry->rating->aggregate[dataform_field__rating::AGGREGATE_MAX], 2);
            $aggrmin = round($entry->rating->aggregate[dataform_field__rating::AGGREGATE_MIN], 2);
            $aggrsum = round($entry->rating->aggregate[dataform_field__rating::AGGREGATE_SUM], 2);
