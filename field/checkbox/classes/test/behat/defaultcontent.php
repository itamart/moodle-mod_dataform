...
/**
 * The dataformfield checkbox default content behat test.
 *
...
namespace dataformfield_checkbox\test\behat;
...
class defaultcontent {
    ...
    public static function steps($options = null) {
        ...
        $fieldname = !empty($options['fieldname']) ? $options['fieldname'] : 'checkboxfield';
        ...
        $steps[] = new Given('I set the field "Add a field" to "checkbox"');
        $steps[] = new Given('I expand all fieldsets');
        $steps[] = new Given('I set the field "Name" to "'. $fieldname. '"');
        $steps[] = new Given('I set the field "Options" to "'. $checkboxoptions. '"');
        ...
        foreach (explode(',', $defaultcontent) as $content) {
            $steps[] = new Given('I click on "'. $content. '" "checkbox"');
        }
        $steps[] = new Given('I press "Save"');

        // Outcome: An entry added with the changed content.
        foreach (explode(',', $defaultcontent) as $content) {
            $steps[] = new Given('I do not see "'. $content. '"');
        }
        ...
        foreach (explode(',', $somecontent) as $content) {
            $steps[] = new Given('I click on "'. $content. '" "checkbox"');
        }
        $steps[] = new Given('I press "Save"');
