...
/**
 * The dataformfield select default content behat test.
 *
...
namespace dataformfield_select\test\behat;
...
class defaultcontent {
    ...
    public static function steps($options = null) {
        ...
        $fieldname = !empty($options['fieldname']) ? $options['fieldname'] : 'selectfield';
        ...
        $steps[] = new Given('I set the field "Add a field" to "select"');
        $steps[] = new Given('I expand all fieldsets');
        $steps[] = new Given('I set the field "Name" to "'. $fieldname. '"');
        $steps[] = new Given('I set the field "Options" to "'. $selectoptions. '"');
        ...
        $steps[] = new Given('I set the field "field_'. $fieldid. '_-1_selected" to ""');
        ...
        // 5. Add an entry with changing its content.
        $steps[] = new Given('I follow "Add a new entry"');
        $steps[] = new Given('I set the field "field_'. $fieldid. '_-1_selected" to "'. $somecontent. '"');
        $steps[] = new Given('I press "Save"');
