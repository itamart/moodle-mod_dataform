...
namespace dataformfield_text\test\behat;
...
class defaultcontent {
    ...
    public static function steps($options = null) {
        ...
        $steps[] = new Given('I set the field "Add a field" to "text"');
        $steps[] = new Given('I expand all fieldsets');
        $steps[] = new Given('I set the field "Name" to "'. $fieldname. '"');
        $steps[] = new Given('I set the field "Text" to "'. $defaultcontent. '"');
        ...
        $steps[] = new Given('I expand all fieldsets');
        $steps[] = new Given('I set the field "Text" to "'. $newdefaultcontent. '"');
        $steps[] = new Given('I press "Save changes"');
        ...
        $steps[] = new Given('I follow "Edit '. $fieldname. '"');
        $steps[] = new Given('I expand all fieldsets');
        $steps[] = new Given('I set the field "Text" to ""');
        $steps[] = new Given('I press "Save changes"');
